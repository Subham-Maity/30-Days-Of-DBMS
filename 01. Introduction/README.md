...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://media.giphy.com/media/N1TzDcgCw0m2Lors1I/giphy.gif"
                 width="450"/>
</p>
...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://github.com/Subham-Maity/30-Days-Of-DBMS/blob/main/01.%20Introduction/img/change1.png?raw=true"
                 width="450"/>
</p>
...
a. Data is a collection of raw, unorganized facts and details like text, observations, figures, symbols,and descriptions of things etc. In other words, data does not carry any specific purpose and has no significance by itself.
...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://media.giphy.com/media/UMyvk17PIo3SiZQWju/giphy.gif"
                 width="450"/>
  </p>
...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://media.giphy.com/media/jFzojLrYSgJlGUuwq9/giphy.gif"
                 width="450"/>
    </p>
...
| Individual and sometimes unrelated | Maps out data to provide a big-picture view |
| Meaningless on its own | Meaningful after analyzed and interpreted |
| Does not depend on information | Depends on data |
| Typically in the form of graphs, numbers, figures or statistics | Typically presented through words, language, thoughts and ideas |
| Not sufficient for decision-making | Useful for decision-making |
...
| Student Name | Grade | Section | Roll | Address | Contact |
| --- | --- | --- | --- | --- | --- |
| Rohan Patel | A+ | 10 | 1 | 123 main st | 555-555-5555 |
| Priya Sharma | B- | 10 | 2 | 456 park ave | 555-555-5556 |
| Vikas Gupta | C+ | 11 | 3 | 789 Elm st | 555-555-5557 |
...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://github.com/Subham-Maity/30-Days-Of-DBMS/blob/main/01.%20Introduction/img/2.png?raw=true"
                 width="750"/>
        </p>
...
<p align="center">
            <img style={{ position: "relative" ,opacity: 1 ,borderRadius: "10px" ,overflow: "hidden" , marginTop:"20px" , marginBottom: "20px"}}
                 src="https://github.com/Subham-Maity/30-Days-Of-DBMS/blob/main/01.%20Introduction/img/3.png?raw=true"
                 width="750"/>
   </p>

| DBMS | File Systems |
| --- | --- |
| Provides a way to store and retrieve database information that is both convenient and efficient | Data Redundancy and inconsistency, Difficulty in accessing data, Data isolation, Integrity problems, Atomicity problems, Concurrent-access anomalies, Security problems |
| Organizes and manages data efficiently | Basic way of storing and accessing data |
| Ensures data integrity and security | Doesn't ensure data integrity and security |
